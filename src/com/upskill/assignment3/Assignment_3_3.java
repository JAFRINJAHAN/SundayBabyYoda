package com.upskill.assignment3;
 /* 3.Bank is a class that provides functionality to get interest rate.
     Display different interest rate using rate functionality for Chase, City and TD banks 
...
public class Assignment_3_3 {
	...
	public static void main(String[] args) {
		Assignment_3_3 myobj = new Assignment_3_3();
		myobj.displayInterestRate();
		new ChaseBank().displayInterestRate();
