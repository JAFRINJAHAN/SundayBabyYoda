...
//How you handle error in Java? Ans- We use Java exceptions try-catch-finally block 
...
public class Class_6_Exception_TryCatchFinale {
	 ...
	 * 2. ArrayIndexOutOfBoundsException - an array has been accessed with an illegal index.
	   3. ClassNotFoundException - try to access a class whose
	 * definition is not found 
	 * 4. FileNotFoundException - a file is not
	 * accessible or does not open. 
	 * 5. IOException - input-output operation
	 * failed or interrupted 
	 * 6. InterruptedException - thread is waiting,sleeping, or doing some processing, and it is interrupted.
	 * 7. NoSuchFieldException - class does not contain the field or variable
	 * specified 
	 ...
	 * 10. NumberFormatException - a method could not convert a string into a
	 * numeric format 
	 * 11. RuntimeException - any exception which occurs during
	 * runtime. 
	 * 12. StringIndexOutOfBoundsException - String class methods to
	 * indicate that an index is either negative or greater than the size of the string 
	 B. User-Defined Exceptions - User can also create exception where
	 * the error situations is not covered by java
	 */
